...
function Badge({ className, variant = 'default', ...props }: BadgeProps) {
  return (
    <div
      className={twMerge(
        'inline-flex items-center rounded-md border px-2 py-0.5 text-xs font-bold transition-colors focus:outline-none focus:ring-2 focus:ring-slate-950 focus:ring-offset-2',
        variant === 'default' &&
