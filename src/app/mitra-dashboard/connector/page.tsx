    ...
    <div className="page-shell flex-1 py-8">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-6">
        ...
        <div className="bg-amber-50 border border-amber-200 text-amber-900 rounded-xl p-5 text-xs font-semibold leading-relaxed">
          ...
          Silakan buka tab <strong>Connector & Pengadaan</strong> di <a href="/mitra-dashboard" className="text-brand-orange hover:underline font-semibold">Portal Saya</a> untuk mengelola transfer stok dan bergabung dalam pengadaan massal.
        </div>
      </div>
    </div>
  );
