...
import { Building2, Users, ShieldAlert, CheckCircle2, ArrowRight, Check, Loader2, ShoppingCart, Landmark } from 'lucide-react';
...
export default function SelectRolePage() {
  ...
  return (
    <div className="min-h-screen bg-[#f7f8fa] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 font-sans">
      <div className="max-w-md w-full space-y-6">

        {/* Title Header */}
        <div className="text-center space-y-2">
          <span className="text-[10px] bg-brand-navy text-white px-2.5 py-1 rounded-full font-semibold uppercase tracking-wider">
        ...
        <div className="space-y-4">
          ...
          {/* 1. Admin Role - hanya tampil bagi pengguna yang sudah berperan Admin */}
          {userData?.role === 'admin' && (
            <div
              onClick={() => setSelectedRole('admin')}
              className={`cursor-pointer p-4 bg-white border rounded-2xl transition-all duration-200 flex gap-4 items-start ${selectedRole === 'admin'
                ? 'border-brand-navy ring-1 ring-brand-navy/20 shadow-md bg-brand-cream/5'
                : 'border-slate-200 hover:border-slate-300'
                }`}
            >
              <div className={`h-10 w-10 rounded-xl flex items-center justify-center shrink-0 ${selectedRole === 'admin' ? 'bg-brand-navy text-white' : 'bg-slate-100 text-slate-500'
                }`}>
                <ShieldAlert className="h-5 w-5" />
              </div>
              <div className="space-y-1">
                <h3 className="font-semibold text-sm text-slate-900">Administrator ARUNA (Admin)</h3>
          ...
          <div
            ...
            className={`cursor-pointer p-4 bg-white border rounded-2xl transition-all duration-200 flex gap-4 items-start ${selectedRole === 'buyer'
              ? 'border-brand-navy ring-1 ring-brand-navy/20 shadow-md bg-brand-cream/5'
              : 'border-slate-200 hover:border-slate-300'
              }`}
          >
            <div className={`h-10 w-10 rounded-xl flex items-center justify-center shrink-0 ${selectedRole === 'buyer' ? 'bg-brand-red text-white' : 'bg-slate-100 text-slate-500'
              }`}>
              <Building2 className="h-5 w-5" />
            </div>
            <div className="space-y-1.5 w-full">
              <h3 className="font-semibold text-sm text-slate-900">Buyer Industri (Offtaker)</h3>
              <p className="text-[11px] text-slate-500 leading-normal">
              ...
              {selectedRole === 'buyer' && (
                <div className="pt-3 border-t border-slate-100 mt-2 space-y-3" onClick={(e) => e.stopPropagation()}>
                  <div className="flex items-center gap-2">
                    ...
                    />
                    <label htmlFor="new-buyer-chk" className="text-xs font-semibold text-slate-700 cursor-pointer select-none">
                  ...
                  {!isNewBuyer ? (
                    ...
                    <div className="space-y-2.5 bg-slate-50/60 p-3.5 rounded-xl border border-slate-200">
                      <span className="text-[9px] font-semibold text-brand-red uppercase tracking-wider block">Registrasi & Verifikasi Pembeli Baru</span>

                      <div className="space-y-1">
                        <label className="text-[9px] font-semibold text-slate-500 block uppercase">Skala / Tipe Bisnis:</label>
                      ...
                      <div className="space-y-1">
                        <label className="text-[9px] font-semibold text-slate-500 block uppercase">
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        <div className="space-y-1">
                          <label className="text-[9px] font-semibold text-slate-500 block uppercase">Kota Pabrik/Gudang:</label>
                          <input
                            type="text"
                        ...
                        <div className="space-y-1">
                          <label className="text-[9px] font-semibold text-slate-500 block uppercase">Sektor Industri:</label>
                          <input
                            type="text"
                      ...
                      <div className="space-y-1">
                        <label className="text-[9px] font-semibold text-slate-500 block uppercase">Alamat Lengkap Pengiriman (Pabrik / Gudang):</label>
                        <textarea
                      ...
                      <div className="grid grid-cols-2 gap-2 border-t border-slate-100 pt-2.5">
                        <div className="space-y-1">
                          <label className="text-[9px] font-semibold text-slate-500 block uppercase">NIB (Nomor Induk Berusaha):</label>
                          <input
                            type="text"
          ...
          <div
            ...
            className={`cursor-pointer p-4 bg-white border rounded-2xl transition-all duration-200 flex gap-4 items-start ${selectedRole === 'koperasi'
              ? 'border-brand-navy ring-1 ring-brand-navy/20 shadow-md bg-brand-cream/5'
              : 'border-slate-200 hover:border-slate-300'
              }`}
          >
            <div className={`h-10 w-10 rounded-xl flex items-center justify-center shrink-0 ${selectedRole === 'koperasi' ? 'bg-brand-orange text-white' : 'bg-slate-100 text-slate-500'
              }`}>
              <Users className="h-5 w-5" />
            </div>
            <div className="space-y-1.5 w-full">
              <h3 className="font-semibold text-sm text-slate-900">Ketua Koperasi Desa (Penyedia)</h3>
              <p className="text-[11px] text-slate-500 leading-normal">
              ...
              {selectedRole === 'koperasi' && (
                <div className="pt-3 border-t border-slate-100 mt-2 space-y-3" onClick={(e) => e.stopPropagation()}>
                  <div className="flex items-center gap-2">
                    ...
                    />
                    <label htmlFor="new-coop-chk" className="text-xs font-semibold text-slate-700 cursor-pointer select-none">
                  ...
                  {!isNewCoop ? (
                    ...
                    <div className="space-y-2.5 bg-slate-50/60 p-3.5 rounded-xl border border-slate-200">
                      <span className="text-[9px] font-semibold text-brand-orange uppercase tracking-wider block">Registrasi Koperasi Desa Baru</span>

                      <div className="space-y-1">
                        <label className="text-[9px] font-semibold text-slate-500 block uppercase">Nama Koperasi:</label>
                        <input
                          type="text"
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        <div className="space-y-1">
                          <label className="text-[9px] font-semibold text-slate-500 block uppercase">Kabupaten/Kota:</label>
                          <input
                            type="text"
                        ...
                        <div className="space-y-1">
                          <label className="text-[9px] font-semibold text-slate-500 block uppercase">Provinsi:</label>
                          <input
                            type="text"
                      ...
                      <div className="space-y-1">
                        <label className="text-[9px] font-semibold text-slate-500 block uppercase">Alamat Lengkap Gudang:</label>
                        <input
                          type="text"
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        <div className="space-y-1">
                          <label className="text-[9px] font-semibold text-slate-500 block uppercase">Nama Ketua Koperasi:</label>
                          <input
                            type="text"
                        ...
                        <div className="space-y-1">
                          <label className="text-[9px] font-semibold text-slate-500 block uppercase">No. Telepon Ketua:</label>
                          <input
                            type="text"
                      ...
                      <div className="space-y-1">
                        <label className="text-[9px] font-semibold text-slate-500 block uppercase">ID Registrasi SimkopDes (Opsional):</label>
                        <input
                          type="text"
                      ...
                      <div className="grid grid-cols-2 gap-2 border-t border-slate-100 pt-2.5">
                        <div className="space-y-1">
                          <label className="text-[9px] font-semibold text-slate-500 block uppercase">Nomor NIB Koperasi (Opsional):</label>
                          <input
                            type="text"
                        ...
                        <div className="space-y-1">
                          <label className="text-[9px] font-semibold text-slate-500 block uppercase">Foto/Scan Dokumen NIB:</label>
                          <input
                            type="file"
                            accept="image/*"
                            onChange={(e) => setNibFile(e.target.files?.[0] || null)}
                            className="w-full text-[10px] text-slate-500 file:mr-2 file:py-1.5 file:px-2.5 file:rounded-lg file:border-0 file:text-[10px] file:font-semibold file:bg-orange-50 file:text-brand-orange hover:file:bg-orange-100 cursor-pointer"
                          />
                        </div>
                      </div>
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        <div className="space-y-1">
                          <label className="text-[9px] font-semibold text-slate-500 block uppercase">SK Pendirian Koperasi (Opsional):</label>
                          <input
                            type="text"
                        ...
                        <div className="space-y-1">
                          <label className="text-[9px] font-semibold text-slate-500 block uppercase">Foto/Scan SK Pendirian:</label>
                          <input
                            type="file"
                            accept="image/*"
                      ...
                      <div className="space-y-1.5 pt-1.5">
                        <label className="text-[9px] font-semibold text-slate-500 block uppercase">Tentukan Lokasi Gudang (Klik pada Peta):</label>
          ...
          <div
            ...
            className={`cursor-pointer p-4 bg-white border rounded-2xl transition-all duration-200 flex gap-4 items-start ${selectedRole === 'customer'
              ? 'border-brand-navy ring-1 ring-brand-navy/20 shadow-md bg-brand-cream/5'
              : 'border-slate-200 hover:border-slate-300'
              }`}
          >
            <div className={`h-10 w-10 rounded-xl flex items-center justify-center shrink-0 ${selectedRole === 'customer' ? 'bg-brand-red text-white' : 'bg-slate-100 text-slate-500'
              }`}>
              <ShoppingCart className="h-5 w-5" />
            </div>
            <div className="space-y-1">
              <h3 className="font-semibold text-sm text-slate-900">Pelanggan Umum (Customer)</h3>
              <p className="text-[11px] text-slate-500 leading-normal">
          ...
          {/* 5. Pemerintah Role - hanya tampil bagi Admin atau pengguna yang sudah berperan Pemerintah */}
          {(userData?.role === 'admin' || userData?.role === 'pemerintah') && (
            <div
              onClick={() => setSelectedRole('pemerintah')}
              className={`cursor-pointer p-4 bg-white border rounded-2xl transition-all duration-200 flex gap-4 items-start ${selectedRole === 'pemerintah'
                ? 'border-brand-navy ring-1 ring-brand-navy/20 shadow-md bg-brand-cream/5'
                : 'border-slate-200 hover:border-slate-300'
                }`}
            >
              <div className={`h-10 w-10 rounded-xl flex items-center justify-center shrink-0 ${selectedRole === 'pemerintah' ? 'bg-brand-navy text-white' : 'bg-slate-100 text-slate-500'
                }`}>
                <Landmark className="h-5 w-5" />
              </div>
              <div className="space-y-1">
                <h3 className="font-semibold text-sm text-slate-900">Pemerintah / Instansi Dinas (Government)</h3>
                <p className="text-[11px] text-slate-500 leading-normal">
        ...
        <Button
          ...
          className="w-full py-3 bg-brand-red hover:bg-brand-red/90 text-white font-semibold text-sm flex items-center justify-center gap-2 rounded-xl shadow-md transition-all duration-200 disabled:opacity-50"
        >
