...
export default function Error({
  ...
  return (
    <div className="flex-1 flex items-center justify-center px-4 py-16 bg-[#f7f8fa]">
      <div className="w-full max-w-md text-center space-y-5">
        ...
        <div className="space-y-1.5">
          <h1 className="text-lg font-semibold text-slate-900">Terjadi Sedikit Kendala</h1>
        ...
        <div className="flex items-center justify-center gap-2">
          <button
            onClick={reset}
            className="inline-flex items-center gap-1.5 rounded-lg bg-brand-navy px-4 py-2.5 text-sm font-semibold text-white hover:bg-brand-navy/90 transition-colors cursor-pointer"
          >
            <RefreshCw className="h-4 w-4" /> Coba Lagi
          </button>
          <Link
            href="/"
            className="inline-flex items-center gap-1.5 rounded-lg border border-slate-200 bg-white px-4 py-2.5 text-sm font-semibold text-slate-600 hover:bg-slate-50 transition-colors"
          >
